...
<head>
    ...
    <title>Купить холодильное оборудование в СПБ - цены на промышленное холодильно оборудование в КБхолд</title>
    ...
    <main>
        ...
        <div class="main-block">
            ...
            <div class="category-main-block">
                <?php
                addindexCatUser($category, $categoryindex);
                ?>
            </div>
        </div>
        ...
        <div class="conteiner-slider">
            ...
            <div class="hidden-block">
                ...
                <div id="slider" class="slide-move-block">
                    <?php
                    addSliderUser($productsSale, $TableProdAll, $TablePhotoProd);
                    ?>
